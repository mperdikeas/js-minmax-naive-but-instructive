    ...
    describe('winning cases', function() {    
            ...
            assert.throws(function() {
                for (let i = 10; i < 15; i++)
                    minmaxRecur(i
                                , GameRules
                                , evaluator
                                , 1)}, 'minmax called on terminal state');
        });
        it('case 001', function() {
            const x: TMinMaxResult<Move> = minmaxRecur(9
                                                       , GameRules
                                                       , evaluator
                                                       , 30);
        ...
        it('case 002', function() {
            [1,2,3,4].forEach(function(i) {
                ...
                plies.forEach(function(depth) {
                    const x: TMinMaxResult<Move> = minmaxRecur(10-i
                                                               , GameRules
                                                               , evaluator
                                                               , depth);
        ...
        it('case 004', function() {
            ...
            counterAndBestMoves.forEach(([counter, expectedBestMove])=>{
                const x: TMinMaxResult<Move> = minmaxRecur(counter
                                                           , GameRules
                                                           , evaluator
                                                           , 3);
    ...
    describe('losing cases', function() {    
        ...
        it('case 001', function() {
            [0,5].forEach(function(i) {
                const x: TMinMaxResult<Move> = minmaxRecur(i
                                                           , GameRules
                                                           , evaluator
                                                           , 30);
